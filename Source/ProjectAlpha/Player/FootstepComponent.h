...
class PROJECTALPHA_API UFootstepComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	TWeakObjectPtr<APA_Character> Owner;
	TWeakObjectPtr<APA_Controller> OwnerController;
